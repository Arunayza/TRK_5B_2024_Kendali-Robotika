...
left_speed = 2
right_speed = 2
durasi_lurus = 17.9  # Durasi untuk bergerak lurus
...
for i in range(4):  # Mengulangi pola lurus → belok sebanyak 4 kali
    ...
    for step in range(turn_steps):
        ...
        # Hanya menampilkan setiap 6 langkah
        if step % 6 == 0 or step == turn_steps - 1:
